  ...
  (0, _createClass2.default)(GameBoard, [{
    ...
    value: function createGrid(level) {
      ...
      level.forEach(function (square) {
        ...
        _this2.grid.push(div); // if square equals dot
    ...
    key: "addObject",
    value: function addObject(pos, objects) {
      var _this$grid$pos$classL;

      (_this$grid$pos$classL = this.grid[pos].classList).add.apply(_this$grid$pos$classL, (0, _toConsumableArray2.default)(objects));
    }
  }, {
    key: "removeObject",
    value: function removeObject(pos, objects) {
      var _this$grid$pos$classL2;

      (_this$grid$pos$classL2 = this.grid[pos].classList).remove.apply(_this$grid$pos$classL2, (0, _toConsumableArray2.default)(objects));
    }
  }, {
    key: "rotateDiv",
    // rotates pacman
...
var Pacman = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Pacman, [{
    ...
    value: function getNextMove(objectExist) {
      ...
      var hitWall = objectExist(nextMovePos, _setup.OBJECT_TYPE.WALL);
      var hitGhostLair = objectExist(nextMovePos, _setup.OBJECT_TYPE.GHOSTLAIR);
...
var startButton = document.querySelector('#start-button'); // Game Consts
...
var timer = null;
var gameWin = false;
var powerPillActive = false; // when pacman eats power pill
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "63913" + '/');
